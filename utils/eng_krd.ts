...
export const translations = {
  krd: {
    ...
    go_back: "گەڕانەوە",
    course_not_found: "خولەکە نەدۆزرایەوە",
    filter_courses: "فلتەری خولەکان",
    apply: "جێبەجێکردن",
    register_new_student: "تۆمارکردنی خوێندکاری نوێ",
    video_permitted: "بینینی ڤیدیۆ رێپێدراوە",
    video_not_permitted: "بینینی ڤیدیۆ رێ پێنەدراوە",
    number_of_lessons: "ژمارەی وانە",
    list_of_videos: "لیستی ڤیدیۆکان",
  ...
  eng: {
    ...
    video_permitted: "Video play permitted",
    video_not_permitted: "Video play not permitted",
    number_of_lessons: "Number of lessons",
    list_of_videos: "Video list",
